        ...
        @foreach($category_tops as $category_top)
            <div class="col-sm-8">
                <div class="row vista-web">
                    <b>
                        <a href="{{ route('sessionsis.show',$category_top->id.'-'.str_slug($category_top->head)) }}" class="a-corregido2">
    ...
    @foreach($subarticles as $subarticle)
        ...
        <div class="row vista-web" style="margin-bottom: 10px ">
            <div class="col-sm-6 ">
                ...
                <a href="{{ route('sessionsis.show',$subarticle->id.'-'.str_slug($subarticle->head)) }}" class="a-corregido2">
            ...
            <div class="col-sm-6 ">
                <div class="row">
                    <a href="{{ route('sessionsis.show',$subarticle->id.'-'.str_slug($subarticle->head)) }}">
    ...
    @foreach($articles as $article)
        ...
        <div class="row vista-web" style="margin-bottom: 10px ">
            <div class="col-sm-6 ">
                ...
                <a href="{{ route('sessionsis.show',$article->id.'-'.str_slug($article->head)) }}" class="a-corregido2">
            ...
            <div class="col-sm-6 ">
                <div class="row">
                    <a href="{{ route('sessionsis.show',$article->id.'-'.str_slug($article->head)) }}">
