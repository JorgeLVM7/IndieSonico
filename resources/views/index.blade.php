    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide fixed-absolute" data-ride="carousel">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="row bw">
                        <a class="twitter-timeline" data-lang="es" data-width="350" data-height="250" data-dnt="false" href="https://twitter.com/IndieSonico?ref_src=twsrc%5Etfw">Tweets by IndieSonico</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
                </div>
            </div>
        </div>
