...
@section('content1')
                    ...
                    @foreach($mediums as $medium)
                        ...
                        <div id="" class="col-sm-12">
                            <div id="" class="card" style="border:none !important;">
                                <a href="{{ route('move.show',$medium->id.'-'.str_slug($medium->head))}}">
    ...
    <div class="row col-12">
        <div class="col-sm-12">
            {{--Aqui va  un id="tops1"--}}
            <div id="" class="row">
                <a  class="twitter-share-button esp" data-size="large" href="https://twitter.com/home?status=http%3A//indiesonico.com/move{{$article->id }}.'-'.{{str_slug($article->head)}}">Twittear</a>
                <div class="fb-share-button" data-href="https://indiesonico.com/move/{{$article->id }}.'-'.{{str_slug($article->head)}}" data-layout="button_count"  data-title="{{$article->head}}"  datasrc="../images/{{$article->path}}" data-size="large" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Findiesonico.com%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Compartir</a></div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        @foreach($bottoms as $bottom)
            ...
            <div id="botoms0" class="col-sm-4">
                <div id="" class="card" style="border:none !important;">
                    <a href="{{ route('move.show',$bottom->id.'-'.str_slug($bottom->head)) }}">
