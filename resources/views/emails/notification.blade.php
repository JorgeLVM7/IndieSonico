...
.header {
    ...
    border-bottom: 3px solid #EFC205;
}
p {
    Margin:0;
}
                                ...
                                <tr>
                                    <td class="inner-td">
                                        <table class="content">
                                            <tr>
                                                <td align="center">
                                                    <img src="https://s19.postimg.cc/5mwgi6k83/logo.png" class="logo">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
    			...
    			<tr>
    				<td class="one-column">
    					<table width="100%">
    						<tr>
    							<td class="inner-td">
    								<p class="h2">Hola {{$subscribers->name_complete}}</p>
    								<p class="center">Tenemos novedades para ti da click en el boton de abajo y enterate cuales son !.</p>
    								<p class="button-holder-center">
    									<a class="btn" href="{{ $msg->body }}">Ingresa aquí</a>
    								</p>
    							</td>
    						</tr>
    					</table>
    			...
    			<tr>
    				<td class="one-column">
    					<table width="100%">
    						<tr>
    							<td class="footer">
    								<img src="https://s19.postimg.cc/5mwgi6k83/logo.png">
    								<p class="footer">sitio web: www.indiesonico.com<br>contacto: indiesonico@gmail.com<br>&copy; IndieSonico, 2018.<br></p>
    							</td>
    						</tr>
    					</table>
    				</td>
